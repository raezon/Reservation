...
class Filter extends Component
{
    ...
    public function filtrer()
    {
        ...
        $partner_getting_address = (new \yii\db\Query())
            ...
            ->limit(100)
            ->all();
        $array_partner_filtered_by_address = $partner_getting_address;
        foreach ($array_partner_filtered_by_address as $array_partner_filtered_by_address) {
            $this->array_partner_filtered_by_address1[] = $array_partner_filtered_by_address['id'];
    ...
    public function correction_date($model)
    {
        ...
        ->all();*/
        $event_partner_date = \app\models\Reservation::find()
            ->andWhere(['<', 'start_reservation', $date_depart])
            ->andWhere(['<', 'start_reservation', $date_arriver])
            ->andWhere(['<', 'end_reservation', $date_arriver])
            ->all();
    ...
    public function getPartnerId()
    {
        ...
        if (!empty($this->array_partner_filtered_by_address1)) {
            ...
            if (!empty($this->filteraf)) {
                ...
                $this->result = array_diff($this->array_partner_filtered_by_address1, $this->array_partner);
        ...
        if (isset($_SESSION['filter'])) {
            ...
            if ($category != 1 && $category != 3 && $category != 8) {
