...
class ReservationDetailController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-reservation-options'],
    ...
    /**
     * 
     * Export ReservationDetail information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new ReservationDetail model by another data,
