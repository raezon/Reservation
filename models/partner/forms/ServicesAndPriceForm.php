...
class ServicesAndPriceForm extends \yii\base\Model
{
    ...
    public function rules()
    {
        return [
            // username rules
            [['produit_nom', 'produit_option', 'produit_type', 'nombre_de_persson', 'quantity', 'description', 'description1', 'price', 'diet', 'imageFile', 'prix_livraison', 'adress', 'prix_serveur', 'area', 'caution', 'extra', 'duration', 'prix_heure', 'nombre_de_equipement', 'adress_roomRental', 'desriptionRoom'], 'required'],
            [['Board', 'System_Sound', 'Micro', 'To_bring_back_cake_of_the_event', 'To_bring_back_drinks', 'Parking_lot', 'Parking_lot_field', 'Subway', 'Subway_field', 'Train', 'Train_field', 'Bus', 'Bus_field', 'Video_projector', 'Wifi', 'currencies_symbol', 'vegan', 'glutenfree', 'Halal', 'Kosher', 'Organic', 'Withoutpork', 'working_day', 'working_night', 'prix_day', 'prix_night', 'Arabic', 'Frensh', 'English', 'Deutsh', 'Japenesse', 'event_cake', 'drink', 'External_food', 'External_Catering', 'Internal_Catering', 'Without_guarantee', 'Minimum_consumption_Price', 'services_F', 'extra_p', 'extra_t', 'services'], 'safe'],
