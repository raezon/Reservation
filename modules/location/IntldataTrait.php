...
/**
 * Trait IntldataTrait is a proxy to \location\intldata static classes
 *
...
trait IntldataTrait
{
    ...
    {
//        return '\\location\\intldata\\' . (new \ReflectionClass(self::class))->getShortName();
        return 'app\\modules\\location\\intldata\\' . (new \ReflectionClass(self::class))->getShortName();
    }
}