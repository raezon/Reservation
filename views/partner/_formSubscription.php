...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'pack' => ['type' => TabularForm::INPUT_TEXT],
        'del' => [
            'type' => 'raw',
            'label' => '',
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowSubscription(' . $key . '); return false;', 'id' => 'subscription-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
