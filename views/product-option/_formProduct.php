...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'currencies_symbol' => ['type' => TabularForm::INPUT_TEXT],
        'number_people' => ['type' => TabularForm::INPUT_TEXT],
        ...
        'condition' => ['type' => TabularForm::INPUT_TEXT],
        'availability' => ['type' => TabularForm::INPUT_TEXT],
        'partner_id' => [
            'label' => 'Partner',
            'type' => TabularForm::INPUT_WIDGET,
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\Partner::find()->orderBy('name')->asArray()->all(), 'id', 'name'),
                'options' => ['placeholder' => 'Choose Partner'],
            ],
            'columnOptions' => ['width' => '200px']
        ],
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  'Delete', 'onClick' => 'delRowProduct(' . $key . '); return false;', 'id' => 'product-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
