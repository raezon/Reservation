...
//geeting the active element
    ...
    if (
      ...
      $.ajax({
        type: "POST",
        url: "?r=site/filter-equipement&price="+prix+"&Distance="+distance+"&Pricebyhour="+Pricebyhour+"&hour="+hour+"&active=" + active,
       // timeout: 5000,
        data: {Pricebyhour:Pricebyhour,hour:hour,Distance:distance},
