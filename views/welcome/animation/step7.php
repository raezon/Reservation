...
<div class="row">
   ...
   <?php $form = ActiveForm::begin([
        ...
        //
        echo "<div class='col-md-6'>";
        echo     $form->field($model3, 'description')->textInput(['style'=>'width:500px','placeholder'=>'Describe your scompany/Service (specialty, expertise, number of years of experience ... etc) this will attract more customers'])->label("Description"); 
        echo "</div>";
        //
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                             ...
                             <div class="col-sm-6">
                                <?= $form->field($ProductItem, "[{$i}]periode")->textInput(['maxlength' => true])->label("Duration") ?>
                            </div>
                             <div class="col-sm-6">
                                <?php
