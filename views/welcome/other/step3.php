...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <?= $form->field($model3, 'partner_category')->hiddenInput(['value' => 9])->label(false); ?>
            <?php
                ...
                <?php foreach ($ProductsItem as $i => $ProductItem) : ?>
                    ...
                    <div class="item panel panel-default">
                        ...
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title pull-left"><b>Products
                                </b></h3>
                        ...
                        <div class="panel-body">
                            ...
                            if (!$ProductItem->isNewRecord) {
                                echo Html::activeHiddenInput($ProductItem, "[{$j}]id");
                            }
                            ?>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="col-sm-6">
                                        <?= $form->field($ProductItem, "[{$j}]name")->textInput([])->label("Name") ?>

                                    </div>
                                    <div class="col-sm-6">
                                        <?= $form->field($ProductItem, "[{$j}]quantity", [
                                            'options' => [
                                                'tag' => 'div',
                                                'class' => '',
                                            ]
                                ...
                                <div class="col-sm-12">
                                    <div class="col-sm-6">
                                        <?= $form->field($ProductItem, "[{$j}]periode", [
                                            'options' => [
                                                'tag' => 'div',
                                                'class' => '',
                                            ]
