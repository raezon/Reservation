...
class FirstDetatil
{
    ...
    public static function widgetMapAndNameOfProduct($partner, $product, $product_parent, $modelmap, $latitude, $longitude, $latFrom, $lngFrom)
    {
        ...
        Modal::end();
        echo "<button onclick=' return false;' data-toggle='modal' class='btn btn-primary add-to-cart'W data-target='#mymodal'>Voir sur la carte</button>";
    }
};
